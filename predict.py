...
def main(args, model_args, best_mae_error):
    ...
    validate(args, model_args, best_mae_error, test_loader, model, criterion, normalizer, test=True)


def validate(args, model_args, best_mae_error, val_loader, model, criterion, normalizer, test=False):
